...
class SystemPortalEditViewBase extends HtmlFormBuild {

	static protected $html_rq = " <span style='color:red;font-weight: bold;'>*</span>";
	private $validate = false;
	private $form = array("name" => "SystemPortalEditView","method" => "post","onsubmit" => "return false;",);
	function __construct(){
		self::$_property['portal_id']	= array("type" => "hidden","name" => "portal_id","id" => "portal_id","value" => "","display" => "lang.portal_id",);
