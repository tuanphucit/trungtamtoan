...
class highlightSQL {
    ...
    */
    public function addStyle($sql, $string, $color)
    {
        ...
        $word = preg_quote($string);
        /*** highlight the words ***/
        $text = preg_replace("/\b($word)\b/i", '<span style="font-family: sans-serif; font-weight:bold; color:'.$color.';">\1</span>', $sql);
        return $text;
    }
    ...
    public function highlight($sql)
    {
        ...
        return '<span style="font:weight:bold; color:#ff3b0f;">'.$sql.'</span>';
    }
