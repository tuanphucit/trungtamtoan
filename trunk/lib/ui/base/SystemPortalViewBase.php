...
class SystemPortalViewBase extends HtmlFormBuild {

	static protected $html_rq = " <span style='color:red;font-weight: bold;'>*</span>";
	private $validate = false;
	private $form = array("name" => "SystemPortalView",);
	function __construct(){
		self::$_property['portal_id']	= array("value"=>"","type" => "hidden","name" => "portal_id","id" => "portal_id","value" => "","display" => "lang.portal_id",);
		self::$_property['portal_name']	= array("value"=>"","type" => "text","name" => "portal_name","id" => "portal_name","value" => "","display" => "lang.portal_name","required" => "true","class" => "validate[required,custom[onlyLetNumSpec]]","style" => "width:300px;",);
		self::$_property['portal_brief']	= array("value"=>"","type" => "textarea","name" => "portal_brief","id" => "portal_brief","value" => "","display" => "lang.portal_brief","style" => "width:300px;","rows" => "3","cols" => "50",);
		self::$_property['portal_publish']	= array("value"=>"1","type" => "checkbox","name" => "portal_publish","id" => "portal_publish","value" => "1","display" => "lang.enable",);
		self::$_property['portal_btn_OK']	= array("value"=>"","type" => "button-submit","name" => "portal_btn_OK","id" => "portal_btn_OK","value" => "","display" => "lang.submit","class" => "submit",);
		self::$_property['portal_btn_RESET']	= array("value"=>"","type" => "button-reset","name" => "portal_btn_RESET","id" => "portal_btn_RESET","value" => "","display" => "lang.reset","class" => "submit",);
